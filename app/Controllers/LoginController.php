    ...
    public function logueo_ingreso()
    {
        ...
        try {
            ...
            if ($userData) {
                ...
                $accessData = $usuarioModel->getAccessData($userData['idusuarios'], $sucursal); // Implementa este método en tu modelo
                ...
                if ($accessData) {
                    $fvencecertificado = $accessData->venc_crt;

                    if ($fvencecertificado < $actual) {
                    ...
                    return $this->response->setJSON([
                        'success' => false,
                        'mensaje' => 'No tiene acceso a la sucursal elegida'
                    ]);
                }
            } else {
                return $this->response->setJSON([
